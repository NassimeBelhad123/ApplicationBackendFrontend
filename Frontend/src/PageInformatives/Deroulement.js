...
function DeroulementStagiaire(){
    return (
        <div className="description">
            <h4>Édition  - Directives pour les étudiants</h4>
            <ul>
            <li> Tâches à effectuer par l'étudiant à la session d'automne  (c'est-à-dire maintenant):</li>

            <li>Au plus tard le mardi 18 septembre à 12h00: Produire un CV que vous devez remettre au coordonnateur des stages (Sylvain Labranche). </li>
            <li>En format "Word" ou en format PDF que vous allez remettre sur Moodle pour le cours "2018-2019 : Stages de fin d'études en informatique".
				   Vous devez remettre un seul fichier .ZIP (pas d'autre format accepté) nommé
				   NomFamillePrenom.ZIP (pas d'espace, ni d'accent dans le nom du fichier)</li>

            <li>Contacter les employeurs pour leur proposer vos services</li>       
            <li>Pour chaque employeur que vous contactez vous devez inscrire ses coordonnées sur le formulaire <a href="../documents/contact_employeurs.pdf"/></li>
            <li>Fichier en format <a href="../documents/contact_employeurs.docx">Word.</a></li>

            <li>Lorsque vous rencontrez un employeur (entrevue) vous devez remplir le formulaire 
            ...
            <p>Vous devez rencontrer au moins trois (3) employeurs, à moins bien sûr que vous ayez 
				trouvé votre stage avant. Vous devriez avoir au moins trois formulaires &laquo;rencontre&raquo;, 
				un par employeur rencontré.</p>
            ...
            <p>À l'hiver 
			 ...
			 Lisez ce document concernant 
			      <a href="../documents/Code_ethique_presentation_stages.pdf">l'éthique et les dates (pour Hiver 2019)</a> </p>


            <p className="text-align: left;">Plus de détails pour les 
            ...
            <ul>
                <li>Déroulement des stages / Horaire de travail
...
export default DeroulementStagiaire